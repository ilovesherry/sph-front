  ...
  <div class="register-container">
    ...
    <div class="register">
      ...
      <div class="content">
        ...
        <button @click="getAuthCode" style="height:38px;background-color:skyblue;color:white;border:0px">获取验证码</button>
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="content">
        <label>登录密码:</label>
      ...
      <div class="content">
        <label>确认密码:</label>
        <input type="text" placeholder="请输入确认密码" v-model="passwordConfirm">
        <span class="error-msg">错误提示信息</span>
      </div>
      <div class="controls">
  ...
  export default {
    ...
    methods: {
      ...
      async register() {
        ...
        // ...
        try {
          let data = {phone: this.phone, password: this.password, code: this.code};
